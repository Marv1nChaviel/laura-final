	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> HMS | Contraseña de restablecimiento del paciente</h2></a>
				</div>
...
<input type="password" class="form-control" minlength="6" id="password" name="password" placeholder="Contraseña" required>
