...
<html lang="en">
	<head>
		<title>Medico | Añadir paciente</title>
...
<input type="email" id="patemail" name="patemail" class="form-control"  placeholder="Ingrese la ID del correo electrónico del paciente" required="true" onBlur="userAvailability()">
...
<textarea type="text" name="medhis" class="form-control"  placeholder="EIntroduzca el historial médico del paciente(if any)" required="true"></textarea>
</div>	
