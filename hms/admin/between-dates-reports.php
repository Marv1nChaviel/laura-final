...
<html lang="en">
	<head>
		<title>informes entre Fechas/Reportes | Admin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Informe entre Fechas| Reportes</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Informe entre fechas</span>
									</li>
									<li class="active">
										<span>Reportes</span>
									</li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Informe Entre Fechas</h5>
												</div>
