...
<html lang="en">
	<head>
		<title>Admin | Doctor Especialización</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Ingresar Especialización Doctor">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Administrar <span class="text-bold">Especialización Doctor</span></h5>
